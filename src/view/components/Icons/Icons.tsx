export const BrainIcon = (props: { className: string }) => (
...
export const GithubIcon = (props: { className: string }) => (
  <svg className={props.className} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30">
...
export const XIcon = (props: { className: string }) => (
  <svg className={props.className} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
  ...
  return (
    ...
    >
      <path 
        ...
        strokeLinejoin="round" 
        strokeWidth={1.5}
        d="M6 4v16m4-16v16m4-16v16m4-16v16M4 8h16M4 16h16"
      />
    </svg>
  )
}

export function ZzzIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M21 12a9 9 0 11-18 0 9 9 0 0118 0m-9-3.75h.008v.008H12v-.008zm0 2.25h.008v.008H12V13.5zm0 2.25h.008v.008H12v-.008zm0-9.75h.008v.008H12V6zm0 2.25h.008v.008H12V8.25zm0 2.25h.008v.008H12v-.008z"
      />
    </svg>
  )
}
